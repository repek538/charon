...
mod tests {
    ...
    use charon::systems::actions::{actions, IActionsDispatcher, IActionsDispatcherTrait};
    use charon::models::{Position, m_Position, Moves, m_Moves, Direction};
    ...
    fn contract_defs() -> Span<ContractDef> {
        [
            ContractDefTrait::new(@"charon", @"actions")
                .with_writer_of([dojo::utils::bytearray_hash(@"charon")].span())
        ]
            .span()
    }
