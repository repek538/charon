...
export function setupWorld(provider: DojoProvider) {
	...
	const actions_activeScan = async (snAccount: Account | AccountInterface, targetShip: string) => {
		try {
	...
	const actions_moveShip = async (snAccount: Account | AccountInterface, gameId: BigNumberish, locationX: BigNumberish, locationY: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const actions_passiveScan = async (snAccount: Account | AccountInterface) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const crew_createCrew = async (snAccount: Account | AccountInterface, members: BigNumberish, engineers: BigNumberish, gunners: BigNumberish, medics: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const game_createGame = async (snAccount: Account | AccountInterface, gameId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const oberon_crew_activateAbility = async (snAccount: Account | AccountInterface, crewId: BigNumberish, abilityId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const oberon_crew_assignAbility = async (snAccount: Account | AccountInterface, crewId: BigNumberish, abilityType: CairoCustomEnum) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const oberon_crew_createCrewMember = async (snAccount: Account | AccountInterface, ship: string, role: CairoCustomEnum, health: BigNumberish, morale: BigNumberish, stamina: BigNumberish, intelligence: BigNumberish, strength: BigNumberish, dexterity: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const oberon_crew_healCrewMember = async (snAccount: Account | AccountInterface, crewId: BigNumberish, amount: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const oberon_crew_processCrewTurn = async (snAccount: Account | AccountInterface, ship: string) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const oberon_crew_trainCrewMember = async (snAccount: Account | AccountInterface, crewId: BigNumberish, experience: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const shipoberon_createShip = async (snAccount: Account | AccountInterface, name: BigNumberish, hull: BigNumberish, shield: BigNumberish, pointDefense: BigNumberish, torpedoes: BigNumberish, railgun: boolean, crewCapacity: BigNumberish, fuel: BigNumberish, cargo: BigNumberish, locationX: BigNumberish, locationY: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
